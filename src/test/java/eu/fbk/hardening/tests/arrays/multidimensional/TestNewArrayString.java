...
public class TestNewArrayString extends AbstractTestCorrectnessTemplate
{
    private Class<?> className = testclasses.arrays.multidimensional.NewArrayObject.class;
