...
public class TestNewArrayIntArray extends AbstractTestCorrectnessTemplate {
    private Class<?> className = testclasses.arrays.unidimensional.NewArrayIntArray.class;
