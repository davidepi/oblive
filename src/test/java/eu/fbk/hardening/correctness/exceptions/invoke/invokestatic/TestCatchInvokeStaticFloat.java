...
public class TestCatchInvokeStaticFloat extends AbstractTestCorrectnessTemplate {

    private Class<?> className = testclasses.exceptions.invoke.invokestatic.CatchInvokeStaticFloat.class;
