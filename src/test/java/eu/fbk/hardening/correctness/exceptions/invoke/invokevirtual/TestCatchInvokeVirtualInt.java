...
public class TestCatchInvokeVirtualInt extends AbstractTestCorrectnessTemplate {

    private Class<?> className = testclasses.exceptions.invoke.invokevirtual.CatchInvokeVirtualInt.class;
