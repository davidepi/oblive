...
/**
 * Test the monitor implementation
 */
public class TestMonitorMethod extends AbstractTestCorrectnessTemplate {
    private Class<?> className = testclasses.MonitorMethod.class;
