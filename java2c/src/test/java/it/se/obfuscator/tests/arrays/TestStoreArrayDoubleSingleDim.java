...
public class TestStoreArrayDoubleSingleDim extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.StoreArrayDoubleSingleDim.class;
