...
public class TestStoreArrayObjectSingleDim extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.StoreArrayObjectSingleDim.class;
