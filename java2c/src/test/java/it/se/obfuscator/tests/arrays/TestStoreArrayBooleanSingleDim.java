...
public class TestStoreArrayBooleanSingleDim extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.StoreArrayBooleanSingleDim.class;
