...
public class TestStoreArrayByteSingleDim extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.StoreArrayByteSingleDim.class;
    ...
    {
        return new Class[]{int.class,byte.class};
    }
