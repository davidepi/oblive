...
public class TestNewArrayIntArraySingleDim extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.NewArrayIntArraySingleDim.class;
