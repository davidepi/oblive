...
public class TestStoreArrayBoolean extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.arrays.multidimensional.StoreArrayBoolean.class;
    ...
    {
        return new Class[]{int.class,int.class,boolean.class};
    }
