...
public class TestThrowNullPointerExceptionXLOADFloat extends AbstractTestCorrectnessTemplate {
    private Class<?> className = testclasses.exceptions.nullpointer.arrayload.ThrowNullPointerExceptionXLOADFloat.class;
