...
public class TestCatchInvokeStaticInt extends AbstractTestCorrectnessTemplate {

    private Class<?> className = testclasses.exceptions.invoke.invokestatic.CatchInvokeStaticInt.class;
