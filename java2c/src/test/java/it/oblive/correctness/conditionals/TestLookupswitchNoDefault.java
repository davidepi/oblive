...
public class TestLookupswitchNoDefault extends AbstractTestCorrectnessTemplate {
    private Class<?> className = testclasses.conditionals.LookupswitchNoDefault.class;
