...
public class TestCatchInvokeStaticChar extends AbstractTestCorrectnessTemplate {

    private Class<?> className = testclasses.exceptions.invoke.invokestatic.CatchInvokeStaticChar.class;
