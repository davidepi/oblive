...
public class TestThrowInvokeVirtualShort extends AbstractTestCorrectnessTemplate {

    private Class<?> className = testclasses.exceptions.invoke.invokevirtual.ThrowInvokeVirtualShort.class;
