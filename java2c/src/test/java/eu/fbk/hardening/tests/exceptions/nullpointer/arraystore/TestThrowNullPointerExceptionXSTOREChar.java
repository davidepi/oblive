...
public class TestThrowNullPointerExceptionXSTOREChar extends AbstractTestMethodTemplate
{
    private Class<?> className = testclasses.exceptions.nullpointer.arraystore.ThrowNullPointerExceptionXSTOREChar.class;
